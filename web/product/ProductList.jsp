...
<!--    <link href="css/agency.min.css" rel="stylesheet">-->
    ...
    <body> <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" style="background-color: #696969">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive" style="background-color: #696969">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <c:if test="${cart != null}">
                <a class="navbar-brand" href="ShowCart" title="Cart"><img src="images/payment/basket.png" width="25">${cart.totalQuantity}</a>
                </c:if>
